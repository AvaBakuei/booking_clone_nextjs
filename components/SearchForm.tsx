    ...
    return (
        <Form {...form}>
            <form
                ...
                className="flex flex-col lg:flex-row lg:max-auto items-center justify-center space-x-0 lg-space-x-2 space-y-4 lg:space-y-0 rounded-lg"
            >
                <div className="grid w-full lg:max-w-sm items-center gap-1.5 mx-2">
                    <FormField
                        name="location"
                        render={({field})=>(
                            <FormItem>
